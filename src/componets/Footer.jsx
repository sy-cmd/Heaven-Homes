...
<h3 className={styles.footermainh3}>Haven Homes</h3>
        ...
        <div className='flex flex-row gap-6'>
            <input className={`${styles.footerbtn} font-Roboto `} type="email" placeholder="Enter Email" name="email" required />
            ...
            <div className='flex flex-row gap-27 justify-center justify-self-center items-start w-5xl  max-lg:w-4xl max-lg:flex-col '>
        

<div className='flex flex-col gap-16 max-lg:flex-row'>
...
<div className='flex flex-col gap-16 max-lg:mr-50 max-lg:hidden'>
    <div className='flex flex-col gap-6'>
        <h5 className={`${styles.footermainh5} font-Roboto `}>Subscribe to Our Newsletter</h5>
        <p className={`${styles.footermainpara} font-Roboto w-90`}>Get the latest updates on properties, market trends, and
        exclusive offers. </p>
...
<div className='flex flex-row gap-12  lg:hidden'>
    <div className='flex flex-col gap-6'>
        <h5 className={`${styles.footermainh5} font-Roboto `}>Contact us</h5>
        <p className={`${styles.footermainpara} font-Roboto `}>📞 +1 (555) 123-4567</p>
        <p className={`${styles.footermainpara} font-Roboto `}> ✉️ info@havenhomes.com</p>
    ...
    <div className='flex flex-col gap-3 lg:hidden  '>
         <h5 className={`${styles.footermainh5} font-Roboto `}>Contact us</h5>
          ...
          <div className={styles.Agentca2contsbgI}> <FaInstagram /></div>
            ...
            <div className='flex flex-col  gap-3 justify-self-center items-center p-4 max-lg:mt-150  '>
